...
\
    ...
    F12 - text color CYAN            PRTBYT  $1E3B  Print HEX byte as ASCII\r\n\
";
...
/* 1C06 */ 0x85, 0xF0,         //          STA   PCL
/* 1C08 */ 0x85, 0xFA,         //          STA   POINTL
/* 1C0A */ 0x68,               //          PLA
/* 1C0B */ 0x85, 0xEF,         //          STA   PCH
...
/* 1CDC */ 0xA5, 0xF0,         //  PCCMD   LDA   PCL       ;                               1CDC
/* 1CDE */ 0x85, 0xFA,         //          STA   POINTL
/* 1CE0 */ 0xA5, 0xEF,         //          LDA   PCH
...
/*
    ...
    KIM-1 adoption by Code Monkey King
...
const uint8_t SUPERMON[] = {
    ,
    ...
    ,
...
const uint8_t FEED_ASM[] = {
    0xA9, 0x61, 0x8D, 0x30, 0xA0, 0xA9, 0xA0, 0x8D, 0x31, 0xA0, 0xEA, 0xEA, 0xA0, 0x00, 0xA2, 0x02,
...
static uint16_t getvalue() {
    if (1) {}
    if ((addrtable[opcode]) == (int)acc) return((uint16_t)a);
...
static void putvalue(uint16_t saveval) {
    if (addrtable[opcode] == (int)acc) a = (uint8_t)(saveval & 0x00FF);
...
void step6502() {
    ...
    void (*adt)() = (void (*)()) addrtable[opcode];
    void (*opt)() = (void (*)()) optable[opcode];
    (*adt)();
    (*opt)();

    clockticks6502 += ticktable[opcode];//ticktable[opcode];
    if (penaltyop && penaltyaddr) clockticks6502++;
...
uint8_t read6502(uint16_t address) {
    ...
    if (address >= 0x1800 && address <= 0x1FFF) {  // thanks to Oscar Vermeulen for the below intercepts
        ...
        if (address == 0x1EA0) {
            xprintf("%c", a);            // print char to VGA and serial
        ...
        if (address == 0x1E65) {
            a = read_keyboard();         // get A from keuboard
        ...
        return ROM[address - 0x1800];    // ROM[address - 0x1800];
    }
