...
// SUpermon [A] + custom modifications to assemle from 'file'
const uint8_t ASM[] = {
    0xB0, 0x37, 0x20, 0x51, 0x9C, 0xA2, 0x00, 0x8E, 0x0E, 0x01, 0x8E,
    ...
    0x20, 0x1F, 0x9C, 0x8D, 0x7B, 0x02, 0x8E, 0x7C, 0x02, 0xA9, 0x07, 0x85, 0xC6
};
...
uint8_t read6502(uint16_t address) {
    ...
    // ASM
    if (address >= 0xA033 && address <= 0xF000) return ASM[address - 0xA033];
